...
async function buildApp() {
    ...
    app.addHook('onRequest', async (req, reply) => {
        ...
        reply.header('Access-Control-Allow-Headers', 'Content-Type,X-Admin-Signature,X-Device-Sync-Signature,X-Device-Id,Authorization,X-Api-Key');
    ...
    await (0, public_auth_routes_1.registerClientConfigRoutes)(app);
